<template>
  <div class="userManagement-container">
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText" @selection-change="setSelectRows">
      ...
      <el-table-column label="真实姓名" prop="fullName" show-overflow-tooltip />
      <el-table-column label="联系方式" prop="phone" show-overflow-tooltip />
      <el-table-column label="权限" show-overflow-tooltip>
        <template #default="{ row }">
          <el-tag size="medium">{{ row.permission }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="邮箱" prop="email" show-overflow-tooltip />
      <el-table-column label="注册时间" prop="registrationDate" show-overflow-tooltip />
