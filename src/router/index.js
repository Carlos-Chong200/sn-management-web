...
export const asyncRoutes = [
  ...
  },
  {
    ...
    meta: { title: '设备管理', icon: 'users-cog', permissions: ['admin'] },
    children: [
      {
        path: 'deviceManagement',
        name: 'DeviceManagement',
        component: () => import('@/views/device/deviceManagement/index'),
        meta: { title: '设备管理', badge: 'New' },
      },
      {
        path: 'calibrationManagement',
        name: 'CalibrationManagement',
        component: () => import('@/views/device/calibrationManagement/index'),
        meta: { title: '标定记录' },
      },
      {
        path: 'maintenanceManagement',
        name: 'MaintenanceManagement',
        component: () => import('@/views/device/maintenanceManagement/index'),
        meta: { title: '维修记录' },
      },
    ],
  },
